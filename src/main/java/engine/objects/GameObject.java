...
import engine.userinput.IKeyInput;
import engine.userinput.IMouseInput;
...
public abstract class GameObject implements IKeyInput, IMouseInput, PConstants {
    ...
    /*
     * (non-Javadoc)
     * @see IKeyInput#keyPressed(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IKeyInput#keyReleased(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mousePressed(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mouseReleased(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mouseClicked(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mouseMoved(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mouseDragged(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see IMouseInput#mouseWheel(int)
     */
